...
import com.coupon.favorites.items.shared.infrastructure.util.ApiCallExecutorCallable;
...
public class GetItemsPriceUseCaseImpl implements GetItemsPriceUseCase {
    ...
    private final int SIZE_BATCH=20;

    public GetItemsPriceUseCaseImpl(MeliPublicApiService meliPublicApiService){
